...
import {
    View, Text, ScrollView, Pressable, StyleSheet, Share, Platform,
} from 'react-native';
...
export default function DetalleJai({ route }) {
    ...
    return (
        ...
        >
            {/* Cabecera con color de provincia */}
...
function FilaInfo({ icono, color, texto, grande }) {
    return (
        <View style={styles.fila}>
            <MaterialCommunityIcons name={icono} size={grande ? 22 : 18} color={color} style={styles.filaIcono} />
...
const styles = StyleSheet.create({
    ...
    filaIcono: { marginRight: 10 },
    filaTxt: { flex: 1, fontSize: 15, color: COLORS.text },
    filaTxtGrande: { fontSize: 17, fontWeight: '700' },
